...
Los movimientos incluyen ingresos y gastos y conviven en un único historial.
...
filtros de actividad por todos, manuales y recurrentes
...
La lógica de estadísticas, históricos, distribución por categorías e insights permanece en src/domain, mientras que las páginas y Cards se encargan de representar la información.
